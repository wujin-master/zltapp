...
//        sendUserList();
    ...
    private void sendLoginMsg() {
        ...
        chatMessage.setId("aaaaaa");
        chatMessage.setSender("bbbb");
        chatMessage.setMessage("bbbb上线啦，快来一起聊天吧！");
...
//        sendMsg.setData(this.username);
    ...
    public void onMessage(String message){
        ...
        if(jobj.getString("type").equals("110")){
            String[] strArr = jobj.getString("message").split(",");
            String savePath = "D:/img/test." + strArr[0].replace("data:image/", "").replace(";base64", "");
